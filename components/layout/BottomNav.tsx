...
const NAV_ITEMS = [
  ...
  { href: '/check-in', label: 'Check-In', icon: Sparkles },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white border-t border-beige/50 z-50">
